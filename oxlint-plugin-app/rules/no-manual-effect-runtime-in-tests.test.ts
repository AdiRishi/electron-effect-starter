...
const rule = createOxlintRuleHarness("app/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("app/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("app/no-manual-effect-runtime-in-tests");
